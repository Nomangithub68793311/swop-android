...
import IconmAT from 'react-native-vector-icons/Ionicons' 
  import { Input, Icon, Box, Center, NativeBaseProvider,Button,Divider, Text,   
    Actionsheet,
...
/>
   ...
   <TouchableOpacity onPress={saveEmailToDatabase} style={{alignItems: 'center',marginBottom:10,
