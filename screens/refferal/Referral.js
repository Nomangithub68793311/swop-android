...
function Referral({navigation}) {
    ...
    return (
        ...
        <View style={{alignContent:'center',flex:1,justifyContent:'center'}}>
           ...
           <View>
               <Text style={{textAlign:'center',fontSize:16,color:'#3C3B3B',fontFamily:'Poppins-Regular'}}>Share this code with your friends & 
               {"\n"}family</Text>
           </View>
           ...
           <View style={{marginTop:5}}>
               <Text style={{textAlign:'center',fontSize:16,color:'#3C3B3B',fontFamily:'Poppins-Regular'}}>And your friends get a free NFC chip</Text>
           </View>
        
        <View style={{alignItems:'center'}}>
            
         <TouchableOpacity  onPress={() => 
         {onCopy(copyText);alertinfo()
        }
        }
