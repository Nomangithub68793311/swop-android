      ...
      <ImageBackground source={image2} resizeMode="cover" style={styles.image}> 
                    ...
                    <IconButton name="close-outline" size={40} color="#6C6C6C" style={{alignSelf:'flex-end',marginTop:
                       ...
                       onPress={this.props.handleModelcut} />
                        <View>
                        <Image source={require('../images/widelogo.png')} style={{width: 160,marginTop:windowHeight*.10,resizeMode: 'stretch',alignSelf:'center',
         height: 45}} /> 
                        </View>
...
<View style={{alignItems:'center'}}>
         <TouchableOpacity onPress={this.saveQRCode} style={{alignItems: 'center',marginBottom:30,
