...
const viewWidthnew=windowWidth*.35;
...
const goToBack=()=>{
 ...
 const   renderInner=()=>{
  ...
  return(
    ...
    <Image source={require('../images/gifimage.gif')} style={{width:100,resizeMode: 'stretch',alignSelf:'center',marginTop:10,
        ...
        <View style={{marginTop:5}}>
         ...
         <TouchableOpacity onPress={()=>bottomSheetRef.current.snapTo(1)} style={{alignItems: 'center',marginTop:20,
  ...
  const   renderInnerNew=()=>{
    ...
    return(
      ...
      <Image source={require('../images/right.jpg')} style={{width:100,resizeMode: 'stretch',alignSelf:'center',marginTop:10,
          height:100,borderRadius:100}} />
          <View style={{marginTop:5}}>
                 <Text style={{textAlign:'center',fontSize:16,color:'#3C3B3B',fontFamily:'Poppins-Regular'}}>
                 {"\n"}You are ready to go...
  ...
  <View style={{justifyContent:'center',alignItems:'center'}}>
    ...
    return (
        <>   
            ...
            <View>
            <IconButton name="close-outline" size={40} color="#6C6C6C" style={{alignSelf:'flex-end',marginTop:
                       15,marginRight:15}}
                       onPress={handleModelcut} />
            </View>
            <View>
                <Image source={require('../images/swoptra.png')} style={{width: 100,marginTop:windowHeight*.05,resizeMode: 'stretch',alignSelf:'center',
               height: 100,position:'absolute',top:-4,right:viewWidthnew}} />
               <Image source={require('../images/mobile.png')} style={{resizeMode: 'stretch',alignSelf:'center',marginTop:100,
               }} />
         ...
         <TouchableOpacity onPress={()=>bottomSheetRef.current.snapTo(0)} 	style={{alignItems: 'center',marginBottom:30,
