...
/////if user eidted
 ...
 const handlemodel=() =>{
       ...
       {/* <ScrollView style={{backgroundColor:'white'}}> */}
        ...
        <View  style={{marginTop:10}}>
                ...
                {/* <IconIco name="arrow-back" size={25} color="#6C6C6C" style={{alignSelf:'flex-start',marginTop:
                      ...
                      {list.pic?<Image source={{uri:list.pic}} style={{width: 150,alignSelf:'center',borderRadius:200,
                        height: 150}} />:<Image style={{height:150,width:150,borderRadius:200,alignSelf:'center'}}source={require('../images/propic.png')} />}
                {/* </View> */}
                <View>
   ...
   <TouchableOpacity onPress={()=>navigation.navigate('ContactModal',{list})} style={{alignItems: 'center',
