...
//          }
    return (
        ...
        <ScrollView >
                      ...
                      <View> 
                           <Image source={require('../images/widelogo.png')} style={{width:180,marginTop:10,resizeMode: 'stretch',alignSelf:'center',
                            height: 45}} /> 
                 ...
                 {socialContact.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder} url={item.url}navigation={navigation} idaccount={list._id} id={item.id}  title={item.name} />)})
                         ...
                         <View style={{justifyContent:'center',alignItems:'center',marginVertical:10}}>
                            ...
                            <View  style={{flexDirection:'row',marginTop:5,flexGrow:1,flexWrap:'wrap',justifyContent:'space-evenly'}}>
                 {contact.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder} url={item.url}  navigation={navigation} idaccount={list._id} id={item.id}title={item.name} />)})
                         ...
                         <View style={{justifyContent:'center',alignItems:'center',marginVertical:10}}>
                            ...
                            <View  style={{flexDirection:'row',marginTop:5,flexGrow:1,flexWrap:'wrap',justifyContent:'space-evenly'}}>
                 {music.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder}  url={item.url} navigation={navigation} idaccount={list._id} id={item.id}  title={item.name} />)})
                   ...
                   <View style={{justifyContent:'center',alignItems:'center',marginVertical:10}}>
                            ...
                            <View  style={{flexDirection:'row',marginTop:5,flexGrow:1,flexWrap:'wrap',justifyContent:'space-evenly'}}>
                 {payment.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder}  url={item.url} navigation={navigation} idaccount={list._id} id={item.id} title={item.name} />)})
                   ...
                   <View style={{justifyContent:'center',alignItems:'center',marginVertical:10}}>
                            ...
                            <View  style={{flexDirection:'row',marginTop:5,flexGrow:1,flexWrap:'wrap',justifyContent:'space-evenly'}}>
                 {crypto.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder} url={item.url} navigation={navigation} idaccount={list._id} id={item.id}  title={item.name} />)})
                   ...
                   <View style={{justifyContent:'center',alignItems:'center',marginVertical:10}}>
                            ...
                            <View  style={{flexDirection:'row',marginTop:5,flexGrow:1,flexWrap:'wrap',justifyContent:'space-evenly'}}>
                 {more.map((item)=>{return  (<ContactModalcreate Key={item.id} picname={item.picname} group={item.group} src={item.src} placeholder={item.placeholder} url={item.url} navigation={navigation} idaccount={list._id} id={item.id} title={item.name} />)})
